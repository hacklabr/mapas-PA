...
# Índice de arquitetura — Mapa Cultural do Pará

| Documento | Conteúdo | Quando ler |
|---|---|---|
| `../architecture.md` | Arquitetura interna do sistema | Antes de alterar regras de negócio ou a estrutura de módulos |
